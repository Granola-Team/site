    ...
    return (
        <section className="flex items-center">
            <div className="flex flex-col h-screen px-12">
                <h1 className="mt-24 h-10 text-5xl text-white"><b><span>We make winning software teams.</span></b></h1>
                ...
                <p className="mb-48 text-3xl text-white">Say hello: 
                    <a href="mailto:hello@granola.team" className="mb-0 text-3xl text-logoOrange">
                        hello@granola.team
                    </a></p>
            </div>
